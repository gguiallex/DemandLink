...
const EditUserModal = ({ usuario, setores, onClose }) => {
    ...
    const [selectedSenhaUsuario, setSelectedSenhaUsuario] = useState(null);
    ...
    useEffect(() => {
        if (usuario) {
            ...
            setSelectedSenhaUsuario(usuario.senha || "");
        }
    }, [usuario]);
                    ...
                    <div>
                        <label>
                            ...
                            <select
                                ...
                                className={`selectField ${errors.selectedSetor ? "error" : ""}`}
                            >
